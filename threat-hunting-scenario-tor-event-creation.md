...
2. Install it silently: ```tor-browser-windows-x86_64-portable-14.0.7.exe /S```
...
DeviceProcessEvents
| where ProcessCommandLine contains "tor-browser-windows-x86_64-portable-14.0.7.exe  /S"
...
|-------------|-------------------------------|------------------|-------------------|
| 1.0         | Initial draft                  | `March 15, 2025`  | `Jake Warren`   
